...
class ClientEmployees extends Component {
    ...
    renderClientEmployeesTable() {
        ...
        const actionButton = (cell, row) => {
            return (
                <div>
                    <a className="btn btn-info btn-sm" href={'/customerdashboard/clientemployees/edit/' + row.pk_id_client_emp}>Edit</a>
                </div>
            );
        };
                    ...
                    <div className="panel panel-default">
                        <div className="panel-heading">
                            ...
                            <div className="actions pull-right">
                                <a className="btn btn-success" href="/customerdashboard/clientemployees/add">Add New</a>
                            </div>
                        </div>
