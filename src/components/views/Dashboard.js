                                ...
                                <div className="panel-body">
                                    <div className="row">
                                        <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                            <ul>
                                                <li><i className="fa fa-circle success-color"></i> Chrome</li>
                                                <li><i className="fa fa-circle primary-color"></i> IE</li>
                                                <li><i className="fa fa-circle warning-color"></i> Safari</li>
                                                <li><i className="fa fa-circle info-color"></i> Firefox</li>
                                                <li><i className="fa fa-circle default-color"></i> Other</li>
                                            </ul>
                                        </div>
                                        <div className="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                            <div className="panel panel-default">
                                ...
                                <div className="panel-body widget-gauge">
                                    <canvas width="160" height="100" id="gauge" className=""></canvas>
                                    <div className="goal-wrapper">
                                        <span className="gauge-value pull-left">$</span>
                                        <span id="gauge-text" className="gauge-value pull-left">3,200</span>
                                        <span id="goal-text" className="goal-value pull-right">$5,000</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="panel panel-default chat-widget">
                                ...
                                <div className="panel-body">
                                    <div className="row wrapper animated fadeInRight">
                                        <div className="col-xs-2 col-sm-2 col-md-2 ">
                                            <span className="avatar">
                                                <img src="assets/img/avatar3.png" className="img-circle" alt="" />
                                                <i className="on animated bounceIn"></i>
                                            </span>
                                        </div>
                                    ...
                                    <div className="row wrapper animated fadeInLeft">
                                        ...
                                        <div className="col-xs-2 col-sm-2 col-md-2">
                                            <span className="avatar">
                                                <img src="assets/img/profile.jpg" className="img-circle" alt="" />
                                                <i className="on animated bounceIn"></i>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div className="panel-footer">
                                    <div className="row">
                                        <div className="col-xs-6 col-sm-6 col-md-2">
                                            <h6 className="text-center small-thin uppercase">Mon</h6>
                                            <div className="text-center">
                                        ...
                                        <div className="col-xs-6 col-sm-6 col-md-2">
                                            <h6 className="text-center small-thin uppercase">Tue</h6>
                                            <div className="text-center">
                                        ...
                                        <div className="col-xs-6 col-sm-6 col-md-2">
                                            <h6 className="text-center small-thin uppercase">Wed</h6>
                                            <div className="text-center">
                                        ...
                                        <div className="col-xs-6 col-sm-6 col-md-2">
                                            <h6 className="text-center small-thin uppercase">Thu</h6>
                                            <div className="text-center">
                                        ...
                                        <div className="col-xs-6 col-sm-6 col-md-2">
                                            <h6 className="text-center small-thin uppercase">Fri</h6>
                                            <div className="text-center">
                                        ...
                                        <div className="col-xs-6 col-sm-6 col-md-2">
                                            <h6 className="text-center small-thin uppercase">Sat</h6>
                                            <div className="text-center">
